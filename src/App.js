          ...
          <div className="thirteen wide row column centered">
            <div className="ui column card">
              <a className="image" href="#">
                <img src={process.env.PUBLIC_URL + "/photo's/password.PNG"}></img>
              </a>
            ...
            <div className="ui column card">
              <a className="image" href="#">
                <img src={process.env.PUBLIC_URL + "/photo's/Capture3.PNG"}></img>
              </a>
              <div className="content">
                ...
                <div className="ui card">
                  <a className="image" href="#">
                    <img src={process.env.PUBLIC_URL + "/photo's/dayplanner.PNG"}></img>
                  </a>
                  <div className="content">
            ...
            <div className="ui column card">
              <a className="image" href="#">
                <img src= {process.env.PUBLIC_URL + "public/photo's/newproject.PNG"}></img>
              </a>
              <div className="content">
